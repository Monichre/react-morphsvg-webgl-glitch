...
export default class TabsNav {
    constructor(el, options){
        ...
        this.totalTabs = this.DOM.length;
     ...
     _openTab(tab) {
        ...
        this.current = this.DOM.indexOf(tab);
        ...
        // Set z-indexes.
        this.DOM.forEach(function (tab, idx) {
